...
public class DataStore {
	...
	bookmarks[2][1] = BookmarkManager.getInstance().createBook(4001,
		...
		new String[] { "Ralph Waldo Emerson" }, BookGenre.PHILOSOPHY,
		4.5);
	bookmarks[2][2] = BookmarkManager.getInstance().createBook(4000,
	...
	bookmarks[2][3] = BookmarkManager.getInstance()
		.createBook(4003, "Head First Design Patterns", 2004,
			"O'Reilly Media",
			new String[] { "Eric Freeman", "Bert Bates",
